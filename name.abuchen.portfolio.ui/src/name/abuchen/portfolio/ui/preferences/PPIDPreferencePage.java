...
public class PPIDPreferencePage extends PreferencePage
{
    ...
    protected Control createContents(Composite parent)
    {
        ...
        urlLabel.setText("OAuth Redirect Information:");

        var redirectInfo = new Label(area, SWT.WRAP);
        GridDataFactory.fillDefaults().grab(true, false).span(2, 1).applyTo(redirectInfo);
        redirectInfo.setText("During login, the application will:\n" +
                         "• Start a local callback server (http://localhost:49968/55968/59968/success)\n" +
                         "• Generate a unique authorization URL\n" +
                         "• Open your browser with the authorization URL\n" +
                         "• The OAuth provider will redirect back to the local callback URL\n\n" +
                         "The exact URLs will be determined when you click 'Anmelden' (Login).");
